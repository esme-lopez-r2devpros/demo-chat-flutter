...
class ChannelView extends StatelessWidget {
  ...
  ChannelView({@required this.residents, });
  @override
      ...
      appBar: AppBar(
        ...
        actions:[
          IconButton(
              icon: Icon(Icons.add),
              onPressed: (){
                Route route =MaterialPageRoute(builder: (bc) => ContactosPage(context: context, residents: this.residents, user: user, channels: channels,));
